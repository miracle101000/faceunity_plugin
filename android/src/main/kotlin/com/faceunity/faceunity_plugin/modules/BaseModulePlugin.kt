...
abstract class BaseModulePlugin() {
    ...
    protected val renderKit = FURenderKit.getInstance()

    abstract fun methods(): Map<String, (Map<String, Any>, MethodChannel.Result) -> Any>
    ...
    protected fun parseArguments(arguments: Map<*, *>?): Map<String, Any> {
